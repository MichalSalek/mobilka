...
import { ENDPOINT_LOGIN_USER_POST }            from '../../../READONLY-shared-kernel/application/http/http.endpoints'
import { REQUEST_DTO_API_V1_USER_LOGIN }       from '../../../READONLY-shared-kernel/domain/models/user.dto'
...
export const LoginOrganism = (): ReactElement => {
  ...
  const submitCallback = useCallback(async () => {
    ...
    await defaultHTTPFetcher({
      config         : {
        url : ENDPOINT_LOGIN_USER_POST({ENV_VARS}),
        mode: 'post',
        payload
      },
