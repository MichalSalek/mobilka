...
import { ENDPOINT_USER_LOGIN }            from '../../../READONLY-shared-kernel/domain/http/http.endpoints'
import { REQUEST_DTO_API_V1_USER_LOGIN }       from '../../../READONLY-shared-kernel/domain/models/user/user.dto'
...
export const LoginOrganism = (): ReactElement => {
  ...
  const submitCallback = useCallback(async () => {
    ...
    await defaultHTTPFetcher({
      config         : {
        url : ENDPOINT_USER_LOGIN({ENV_VARS}),
        mode: 'post',
        payload
      },
