...
import { ENDPOINT_USER_DELETE_ANY }           from '../../../READONLY-shared-kernel/domain/http/http.endpoints'
import { REQUEST_DTO_API_V1_USER_DELETE }      from '../../../READONLY-shared-kernel/domain/models/user/user.dto'
...
export const DeleteOrganism = (): ReactElement => {
  ...
  const submitCallback = useCallback(async () => {
    ...
    await defaultHTTPFetcher({
      config         : {
        url : ENDPOINT_USER_DELETE_ANY({ENV_VARS}),
        mode: 'post',
        payload
      },
