import { EVENTS, eventsDisallowedForUI }                                                                                         from '../domain/commands-and-queries/cqrs.config'
...
export type EVENTS_POLICY_TYPE = {
  ...
  utils: {
    ...
    GET_COMMAND_AND_QUERY_EVENTS: () => readonly EVENT_COMMANDS_AND_QUERIES_TYPE[]
  }
}
