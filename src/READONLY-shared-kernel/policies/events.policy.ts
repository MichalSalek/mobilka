...
export const EVENTS_POLICY: EVENTS_POLICY_TYPE = {
  ...
  eventsPermissions: {
    ...
    USER_DELETE_SELF_ONLY         : [ Role.ACCOUNT_HOLDER_ACTIVE, Role.ACCOUNT_HOLDER_INACTIVE, Role.USER_LEVEL_1 ],
    ...
    ACCOUNT_DISPLAY_NAME_CHANGE: [ Role.ACCOUNT_HOLDER_ACTIVE, Role.MASTER_ADMIN ],
    ACCOUNT_PRICING_PLAN_CHANGE: [ Role.ACCOUNT_HOLDER_ACTIVE, Role.ACCOUNT_HOLDER_INACTIVE, Role.MASTER_ADMIN ],
    ACCOUNT_PAYMENT_MAKE       : [ Role.ACCOUNT_HOLDER_ACTIVE, Role.ACCOUNT_HOLDER_INACTIVE, Role.MASTER_ADMIN ],
    ACCOUNT_PAYMENT_GET_STATUS : [ Role.ACCOUNT_HOLDER_ACTIVE, Role.ACCOUNT_HOLDER_INACTIVE, Role.MASTER_ADMIN ]
